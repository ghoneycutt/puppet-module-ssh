    ...
    validations = {
      ...
      'Array of strings (optional)' => {
        name:     ['accept_env', 'allow_groups', 'allow_users', 'authentication_methods',
                   ...
                   'packages', 'permit_listen', 'pubkey_accepted_algorithms', 'set_env'],
      ...
      'Stdlib::Absolutepath' => {
        name:     ['banner_path', 'config_path', 'moduli_file'],
      ...
      'String (optional)' => {
        name:     ['authorized_keys_command', 'authorized_keys_command_user',
                   ...
                   'max_startups', 'permit_user_environment', 'pid_file', 'rdomain', 'rekey_limit',
                   'revoked_keys', 'subsystem', 'trusted_user_ca_keys', 'version_addendum',
                   'xauth_location'],
        valid:    ['string', :undef],
      ...
      'yes or no (optional)' => {
        name:     ['allow_agent_forwarding', 'disable_forwarding', 'expose_auth_info',
                   'gss_api_authentication', 'gss_api_cleanup_credentials',
                   'gss_api_strict_acceptor_check', 'hostbased_authentication',
                   'hostbased_uses_name_from_packet_only', 'ignore_rhosts',
                   'ignore_user_known_hosts', 'kbd_interactive_authentication',
