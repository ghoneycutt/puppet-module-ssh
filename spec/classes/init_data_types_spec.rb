...
describe 'ssh' do
  context 'validate data types of parameters' do
    ...
    validations = {
      ...
      'Boolean' => {
        name:     ['manage_root_ssh_config', 'manage_server', 'purge_keys'],
        valid:    [true, false],
      ...
      'yes or no (optional)' => {
        name:     ['batch_mode', 'canonicalize_fallback_local', 'challenge_response_authentication',
                   ...
                   'kbd_interactive_authentication', 'no_host_authentication_for_localhost',
                   'password_authentication', 'permit_local_command', 'proxy_use_fdpass',
                   'pubkey_authentication', 'stream_local_bind_unlink', 'tcp_keep_alive',
                   'use_roaming', 'visual_host_key'],
        valid:    ['yes', 'no', :undef],
