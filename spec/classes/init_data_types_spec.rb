    ...
    validations = {
      'Array of strings (optional)' => {
        name:     ['canonical_domains', 'canonicalize_permitted_cnames', 'ca_signature_algorithms',
                   ...
                   'pubkey_accepted_key_types', 'send_env', 'set_env', 'user_known_hosts_file'],
      ...
      'String (optional)' => {
        name:     ['bind_address', 'bind_interface', 'control_path', 'control_persist',
                   ...
                   'log_verbose', 'pkcs11_provider', 'protocol', 'proxy_command', 'rekey_limit',
                   'remote_command', 'remote_forward', 'revoked_host_keys', 'tunnel_device', 'user',
                   'xauth_location'],
        valid:    ['string', :undef],
