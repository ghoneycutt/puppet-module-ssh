...
class ssh (
  ...
  Optional[Variant[String[1], Integer[0]]] $forward_x11_timeout = undef,
  ...
  Optional[Variant[String[1], Integer[0]]] $server_alive_count_max = undef,
  Optional[Variant[String[1], Integer[0]]] $server_alive_interval = undef,
